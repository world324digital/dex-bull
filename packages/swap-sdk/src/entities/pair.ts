...
export class Pair {
  ...
  public getOutputAmount(inputAmount: CurrencyAmount<Token>, isGoldUsdcPair: boolean): [CurrencyAmount<Token>, Pair] {
    ...
    const inputAmountWithFee = JSBI.multiply(inputAmount.quotient, isGoldUsdcPair ? _9900 : _9970)
  ...
  public getInputAmount(outputAmount: CurrencyAmount<Token>, isGoldUsdcPair: boolean): [CurrencyAmount<Token>, Pair] {
    ...
    const denominator = JSBI.multiply(JSBI.subtract(outputReserve.quotient, outputAmount.quotient), isGoldUsdcPair ? _9900 : _9970)
