...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and BULL pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and BULL pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from BULL pool', data)
  }
