...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master BULL chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of BULL.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's BULL)`,
