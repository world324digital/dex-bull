...
export const getRoundBaseFields = (tokenSymbol: string) =>
  tokenSymbol === 'BULL' ? roundBaseFieldsCAKE : roundBaseFieldsBNB

export const getBetBaseFields = (tokenSymbol: string) => (tokenSymbol === 'BULL' ? betBaseFieldsCAKE : betBaseFieldsBNB)

export const getUserBaseFields = (tokenSymbol: string) =>
  tokenSymbol === 'BULL' ? userBaseFieldsCAKE : userBaseFieldsBNB
